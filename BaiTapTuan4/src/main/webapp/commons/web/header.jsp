<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <c:choose>
		<c:when test="${sessionScope.account == null}">
			<a href="/BaiTapTuan4/login">Login</a> 
				<a href="/BaiTapTuan4/register">Register</a></li>
		</c:when>
		<c:otherwise>
			<a href="/BaiTapTuan4/member/myaccount">${sessionScope.account.fullName}</a>
				<a href="/BaiTapTuan4/logout">Logout</a></li>
		</c:otherwise>
	</c:choose>
                        </li>
                    </ul>
